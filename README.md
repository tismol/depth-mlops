...
Многие продукты и команды сталкиваются с потребностью понимать геометрию сцены по обычной RGB-картинке: для AR, выделения планов, улучшения сегментаирования и пост-обработки.
